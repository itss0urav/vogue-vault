        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
          ...
          {[
            ...
            },
            {
              ...
              description:
                "Our customer support team is available 24/7 to help you with your queries.",
            },
            {
              title: "Easy Returns",
              description:
            ...
            },
            {
              ...
              description:
                "Your payments are secure with our top-of-the-line encryption methods.",
            },
            {
            ...
            },
            {
              title: "Fast Delivery",
              description:
                "Get your products delivered to your doorstep in as fast as 2 days.",
            },
          ].map((service, index) => (
